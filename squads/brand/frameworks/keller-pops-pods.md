# Points of Parity vs Points of Difference (Kevin Lane Keller)
> O framework que distingue o que a marca precisa igualar (paridade) do que precisa diferenciar — a base do posicionamento competitivo.

---

## Definicao

O framework POPs/PODs de Keller estabelece que o posicionamento de uma marca depende de dois tipos de associacoes: Points of Parity (POPs) — associacoes que a marca PRECISA compartilhar com concorrentes para ser considerada uma opcao legitima na categoria — e Points of Difference (PODs) — associacoes fortes, favoraveis e UNICAS que distinguem a marca dos concorrentes.

POPs sao o "preco de entrada" na categoria. Sem eles, o consumidor desqualifica a marca antes mesmo de considerar seus diferenciais. PODs sao a razao para escolher ESTA marca em vez de outra. O genio do framework esta em reconhecer que diferenciacao sem paridade e tao perigosa quanto paridade sem diferenciacao.

Keller distingue ainda POPs categoricos (necessarios para pertencer a categoria), POPs competitivos (necessarios para neutralizar PODs de concorrentes) e POPs correlacionais (associacoes que consumidores assumem ser negativamente correlacionadas).

---

## Quando Usar

- Definicao ou revisao de posicionamento de marca
- Analise competitiva e identificacao de vulnerabilidades
- Briefing de comunicacao (o que enfatizar vs. o que apenas garantir)
- Decisao de entrada em nova categoria
- Avaliacao de extensoes de marca
...
│   (O que igualar)  │   (O que diferenciar)      │
├────────────────────┼────────────────────────────┤
│                    │                            │
│ CATEGORICOS        │ Criterios para POD valido: │
│ ├─ O basico para   │ ├─ Desejavel pelo target   │
│ │  ser da categoria│ ├─ Entregavel pela marca   │
│ │                  │ └─ Diferenciador real       │
│ COMPETITIVOS       │    vs. concorrentes        │
│ ├─ Neutralizar     │                            │
│ │  PODs rivais     │ Teste de forca:            │
│ │                  │ ├─ Favorabilidade           │
│ CORRELACIONAIS     │ ├─ Unicidade               │
│ ├─ Quebrar trade-  │ └─ Forca da associacao     │
│ │  offs percebidos │                            │
│                    │                            │
└────────────────────┴────────────────────────────┘
```
...
### Passo 1: Definir Frame de Referencia
...
|-----------|---------|---------------|
| Keller Brand Knowledge | Dependente | POPs/PODs operam sobre as associacoes mapeadas no Brand Knowledge |
...
- Keller, K.L. (2013). *Strategic Brand Management*. 4th ed. Pearson. Chapters 2-3.
- Keller, K.L., Sternthal, B. & Tybout, A. (2002). "Three Questions You Need to Ask About Your Brand." *Harvard Business Review*.
